...
public class KeyEvent {
	...
	public static final int KEY_DPAD_UP    = 0x103;
	public static final int KEY_DPAD_DOWN  = 0x104;
	
	public static final int KEY_PAGE_UP   = 0x105;
	public static final int KEY_PAGE_DOWN = 0x106;
